...
// macro for writing CSR registers
...
// page table
#define SATP_SV32 (1u << 31) // A single bit in the satp register, indicates to enable paging in SV32 mode
...
// represents the program state saved in kernel_entry
struct trap_frame {
    uint32_t ra;
    uint32_t gp;
    uint32_t tp;
